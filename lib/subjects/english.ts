    ...
    weeklyTemplate: [
      {
        ...
        focus: 'RAZ 新读 + 跟读',
        duration: '30 分钟',
        materials: ['ABC Reading', 'bookr'],
      },
      {
        day: '周二',
        focus: '自然拼读 + 单词',
        duration: '30 分钟',
        materials: ['phonics app', '单词卡'],
      },
    ...
    weeklyTemplate: [
      {
        ...
        focus: 'OD 新课 + 单词',
        duration: '40-45 分钟',
        materials: ['超凡 AI 课 1-2 节', '单词本'],
      },
      {
        day: '周二',
        focus: 'OD 语法 + 练习册',
        duration: '40-45 分钟',
        materials: ['超凡 AI 课 3-4 节', '课程练习册'],
      },
      {
        day: '周三',
        focus: 'RAZ 精读 + 复述',
        duration: '30 分钟',
        materials: ['ABC Reading', '复述本'],
      },
      {
        day: '周四',
        focus: 'OD 听力/口语',
        duration: '40-45 分钟',
        materials: ['超凡 AI 课 5-6 节', '口袋领航'],
      },
      {
        day: '周五',
        focus: 'OD 单元练习 + 错题',
        duration: '40-45 分钟',
        materials: ['单元练习册', '错题整理'],
      },
      {
        day: '周六',
        focus: 'RAZ 大量阅读',
    ...
    weeklyTemplate: [
      {
        ...
        focus: 'OD2 复习 + 语法',
        duration: '40 分钟',
        materials: ['OD2 练习册', '语法专项'],
      },
      {
        day: '周二',
        focus: 'KET 阅读真题',
        duration: '40 分钟',
        materials: ['KET 真题', '阅读技巧'],
      },
      {
        day: '周三',
        focus: 'KET 听力真题',
        duration: '30 分钟',
        materials: ['KET 听力', '口袋领航'],
      },
      {
        day: '周四',
        focus: 'KET 写作/口语',
        duration: '40 分钟',
        materials: ['KET 写作模板', '口语练习'],
      },
    ...
    weeklyTemplate: [
      {
        ...
        focus: 'OD3 新课 + 学术词汇',
        duration: '45 分钟',
        materials: ['超凡 AI 课', '学术词汇'],
      },
      {
        day: '周二',
        focus: 'PET 阅读/写作',
        duration: '45 分钟',
        materials: ['PET 真题', '写作训练'],
      },
      {
        day: '周三',
        focus: '小托福听力',
        duration: '40 分钟',
        materials: ['小托福听力', '校园场景'],
      },
      {
        day: '周四',
        focus: '小托福语法',
        duration: '40 分钟',
        materials: ['小托福语法', '语言形式'],
      },
    ...
    weeklyTemplate: [
      {
        ...
        focus: '小托福阅读 TPO',
        duration: '45 分钟',
        materials: ['小托福 TPO', '阅读技巧'],
      },
      {
        day: '周二',
        focus: '小托福听力 TPO',
        duration: '45 分钟',
        materials: ['小托福 TPO', '学术听力'],
      },
      {
        day: '周三',
        focus: '语言形式与含义',
...
export const lexileReference: LexileRow[] = [
  {
    ...
    lexileRange: 'BR-200L',
    equivalent: '启蒙',
    description: '一年级目标，培养听读习惯',
  },
  {
    razLevel: 'D-F',
    lexileRange: '200L-400L',
    equivalent: '接近 KET',
    description: '二年级目标，quiz 正确率 80%+',
  },
  {
    razLevel: 'G-I',
    lexileRange: '400L-600L',
    equivalent: 'KET 通过',
    description: '三年级 KET 备考期',
  },
  {
    razLevel: 'J-L',
    lexileRange: '600L-800L',
    equivalent: 'KET 卓越 / PET',
    description: '四年级 PET/小托福衔接期',
  },
  {
    razLevel: 'M+',
    lexileRange: '800L+',
    equivalent: 'PET 卓越 / 小托福 800+',
    description: '五年级冲刺小托福 850+',
  },
];
...
export const od1Schedule: OD1Unit[] = [
  {
    unit: 7,
    bigQuestion: 'How are seasons different?',
    theme: '四季变化',
    weeks: '7.7 - 7.13',
    focus: '词汇 + 阅读导入',
    checkpoint: '能描述四季特征',
  },
  {
    ...
    weeks: '7.14 - 7.20',
    focus: '语法 + 写作',
    checkpoint: '会用 because 表达原因',
  },
  {
    unit: 9,
    bigQuestion: 'How do numbers help us?',
    theme: '数字/数学',
    weeks: '7.28 - 8.3',
    focus: '数字词汇 + 阅读',
    checkpoint: '能用英语表达简单数学',
  },
  {
    unit: 10,
    bigQuestion: 'How do numbers help us?',
  ...
  },
  {
    ...
    weeks: '9.15 - 9.21',
    focus: '地点介词 + 写作',
    checkpoint: '会写 5-8 句住所短文',
  },
  {
    unit: 15,
    bigQuestion: 'How can we make music?',
    theme: '音乐',
    weeks: '10.6 - 10.12',
    focus: '乐器/音乐词汇',
    checkpoint: '能介绍一种乐器',
  ...
  {
    unit: 17,
    bigQuestion: 'What are living things?',
    theme: '生物/非生物',
    weeks: '10.27 - 11.2',
    focus: '生物词汇 + 分类',
    checkpoint: '能区分 living/non-living',
  },
  {
    unit: 18,
    bigQuestion: 'What are living things?',
...
export const englishCheckpoints: Checkpoint[] = [
  ...
  {
    time: '2025.10 中',
    target: 'Unit 13-16 完成，RAZ 升到 F',
    fallback: 'RAZ quiz 不够 80% 则降级重读',
  },
