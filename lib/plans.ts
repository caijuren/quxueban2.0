    ...
    cells: [
      {
        ...
        category: '英语证书',
        target: 'RAZ 爬坡 / OD 基础',
        timing: '二年级全年（2026.09 - 2027.08）',
        fallback: 'RAZ quiz 正确率需 80%+，OD1 暑假前完成',
        priority: 'must',
      },
      {
        grade: '三年级',
        category: '英语证书',
        target: 'KET 卓越 140+',
        timing: '三年级寒假（2028.01-02）',
        fallback: '未达 140 可三年级暑假再考一次',
        repeatable: true,
        priority: 'must',
      },
      {
        grade: '四年级',
        category: '英语证书',
        target: 'PET 卓越 160+ / 小托福首考 800+',
        timing: 'PET 四年级寒假（2029.01-02）+ 小托福四年级春季（2029.04-05）',
        fallback: 'PET 未达卓越则小托福延后；小托福未达 800 则暑假密集补差',
        repeatable: true,
        priority: 'must',
      },
      {
...
export const sgKeyResults: KeyResultNode[] = [
  {
    ...
    result: 'KET 卓越 140+',
    status: 'pending',
    fallbackSignal: '未达 140 则三公节奏偏慢，需三年级暑假再考或加大投入',
  },
  {
    time: '四年级下',
    title: '数学首次试水',
  ...
  },
  {
    time: '四年级寒假~春季',
    title: '英语进阶证书',
    result: 'PET 卓越 160+ / 小托福首考 800+',
    status: 'pending',
    fallbackSignal: 'PET 未达卓越则小托福延后；小托福未达 800 则暑假密集补差',
  },
  {
    time: '五年级上 12 月',
    title: '数学硬通货',
  ...
  },
  {
    ...
    result: '小托福 850+',
    status: 'pending',
    fallbackSignal: '未达 850 则英语竞争力不足，可再考 1 次',
  },
  {
    time: '五年级下 4 月',
    title: '三公网申',
    ...
    phases: [
      {
        time: '二年级全年',
        title: 'RAZ 爬坡 / OD 基础',
        content: 'RAZ 分级阅读（quiz 正确率 80%+）+ Oxford Discover 1 系统学习',
        milestone: 'OD1 暑假前完成，蓝思值 400+',
      },
      {
        time: '三年级上~三年级寒假',
        title: 'KET 体系',
        content: 'Oxford Discover 2 + KET 真题，系统学习语法与写作',
        milestone: 'KET 卓越 140+',
      },
      {
        time: '四年级寒假~四年级春季',
        title: 'PET 卓越 + 小托福首考',
        content: 'Complete PET 冲卓越（寒假）→ 小托福题型适应 + 学术词汇（春季）',
        milestone: 'PET 卓越 160+ / 小托福首考 800+',
      },
      {
        time: '五年级上',
        title: '小托福冲刺',
...
export const plans: RoutePlan[] = [
  {
    ...
    probability: 35,
    requirements: ['AMC8 成绩 20 分+', '小托福 850+ / PET 卓越', '系统奥数学习', '面谈表现突出'],
    milestones: [
      { time: '三年级寒假', task: 'KET 卓越 140+ + 系统奥数启动' },
      { time: '四年级寒假~春季', task: 'PET 卓越 + 小托福首考 800+ + AMC8 首次参赛' },
      { time: '五年级上', task: 'AMC8 二次冲刺 20+ + 小托福 850+' },
