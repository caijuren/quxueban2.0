  ...
  theme: {
    extend: {
      colors: {
        background: '#1e1e2e',
        surface: '#2a2a3e',
        'surface-light': '#383852',
        'surface-elevated': '#454560',
        'surface-highlight': '#525270',
        'border-subtle': 'rgba(255, 255, 255, 0.14)',
        'border-default': 'rgba(255, 255, 255, 0.26)',
        'border-strong': 'rgba(255, 255, 255, 0.40)',
        'border-glow': 'rgba(255, 45, 106, 0.45)',
        ...
        neon: '#ff2d6a',
        'neon-glow': '#ff5c8a',
        'neon-dim': 'rgba(255, 45, 106, 0.22)',
        'neon-violet': '#8b5cf6',
        'neon-violet-glow': '#a78bfa',
        'neon-violet-dim': 'rgba(139, 92, 246, 0.22)',
        accent: '#ff5c8a',
        'accent-glow': '#ff8aa8',
        'accent-dim': 'rgba(255, 92, 138, 0.22)',
        success: '#34d399',
        warning: '#fbbf24',
        danger: '#fb7185',
        'text-primary': '#ffffff',
