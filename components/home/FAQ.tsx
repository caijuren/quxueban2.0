                ...
                <div className="hud-panel hud-panel-hover overflow-hidden">
                  ...
                  >
                    ...
                    <span
                      className={`shrink-0 w-7 h-7 rounded-lg flex items-center justify-center transition-colors duration-200 ${
                        isOpen ? 'bg-primary text-text-primary' : 'bg-surface-light text-text-tertiary'
                      }`}
                      aria-hidden="true"
                    >
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen && (
                      ...
                      >
                        <div className="px-4 pb-4 text-small text-text-tertiary leading-relaxed border-t border-border-subtle pt-3">
                          {faq.answer}
                        </div>
                      </motion.div>
                    )}
