...
export default function Footer() {
  return (
    <footer className="relative py-10 px-4 sm:px-6 lg:px-8 border-t border-border-default/50 bg-surface/30 backdrop-blur-sm">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-5">
          ...
          <nav aria-label="页脚导航">
            <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-micro text-text-tertiary">
