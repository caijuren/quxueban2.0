      ...
      <div className="min-w-0 flex items-center gap-1.5 sm:gap-3 lg:gap-4">
        ...
        <div className="relative" ref={childDropdownRef}>
          <Button
            ...
            className="flex h-11 min-w-0 max-w-[min(48vw,220px)] items-center gap-2 rounded-module border border-border-default py-1.5 pl-1.5 pr-2 text-left transition-all hover:border-border-strong hover:bg-surface-elevated sm:max-w-[240px] sm:gap-3 sm:pr-3"
            aria-label="切换孩子"
