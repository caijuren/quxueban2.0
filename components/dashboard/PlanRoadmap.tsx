...
const routes: RoutePath[] = [
  {
    ...
    checkpoints: [
      ...
      { id: 'sg-2', name: '基础检查', x: 30, type: 'soft', grade: '二年级末', requirement: '数学思维≥60, 英语≥50', status: 'upcoming' },
      { id: 'sg-3', name: '奥数启动', x: 42, type: 'hard', grade: '三年级初', requirement: '已启动系统奥数学习', status: 'upcoming' },
      { id: 'sg-4', name: '英语考证', x: 52, type: 'soft', grade: '三年级末', requirement: '小托福 850+ 或 PET 通过', status: 'upcoming' },
      { id: 'sg-5', name: 'AMC8 首考', x: 62, type: 'soft', grade: '四年级中', requirement: '首次参加 AMC8 竞赛', status: 'upcoming' },
      { id: 'sg-6', name: '竞赛出分', x: 72, type: 'hard', grade: '四年级末', requirement: 'AMC8 20分+ / 思维100 成绩', status: 'upcoming' },
      { id: 'sg-7', name: '综合定位', x: 84, type: 'hard', grade: '五年级初', requirement: '奥数+英语+竞赛全面达标', status: 'upcoming' },
      { id: 'sg-8', name: 'AMC8 冲刺', x: 92, type: 'soft', grade: '五年级上', requirement: 'AMC8 二次考试冲刺高分', status: 'upcoming' },
