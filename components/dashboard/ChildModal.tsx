        ...
        >
          <div className="relative z-10 p-6 pb-4 border-b border-white/5 flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              disabled={saving}
              className="w-8 h-8 rounded-lg bg-black/5 flex items-center justify-center text-slate-600 hover:text-text-primary hover:bg-black/10 transition-all disabled:opacity-50"
              aria-label="关闭"
            >
              <X className="w-4 h-4" />
            </button>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-black/5 text-slate-700 text-xs hover:bg-black/10 transition-colors"
                  >
                  ...
                  {avatarUrl && (
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-black/5 text-slate-600 text-xs hover:bg-black/10 transition-colors"
                    >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="例如：大宝"
                    className={`w-full px-4 py-2.5 rounded-xl bg-black/5 border text-sm text-slate-800 placeholder-slate-500 focus:outline-none focus:border-primary transition-all ${
                      touched && !name.trim()
                        ? 'border-red-500/50'
                        : 'border-white/10'
                    }`}
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 rounded-xl bg-black/5 border border-white/10 text-sm text-slate-800 focus:outline-none focus:border-primary transition-all appearance-none"
                    style={{
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-2.5 rounded-xl bg-black/5 border border-white/10 text-sm text-slate-800 focus:outline-none focus:border-primary transition-all"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="例如：南翔小学"
                      className="w-full pl-9 pr-4 py-2.5 rounded-xl bg-black/5 border border-white/10 text-sm text-slate-800 placeholder-slate-500 focus:outline-none focus:border-primary transition-all"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <Target className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-600" />
                    <input
                      type="text"
                      value={targetSchool}
              ...
              <div>
                ...
                {availableRoutes.length > 0 ? (
                  ...
                  <div className="rounded-xl bg-black/5 border border-white/10 p-4 text-sm text-slate-600 text-center">
                    高中阶段路线即将上线
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full pl-9 pr-4 py-2.5 rounded-xl bg-black/5 border border-white/10 text-sm text-slate-800 placeholder-slate-500 focus:outline-none focus:border-primary transition-all resize-none"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-white/5 flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  disabled={saving}
                  className="px-4 py-2 rounded-lg bg-black/5 text-slate-600 text-sm hover:bg-black/10 transition-all disabled:opacity-50"
                >
                  取消
                </button>
                <button
                  type="submit"
                  disabled={saving}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-primary to-secondary text-text-primary text-sm font-medium hover:shadow-[0_0_20px_rgba(244,63,94,0.4)] transition-all disabled:opacity-70"
                >
                ...
                >
                  ...
                  <div className="flex items-center justify-end gap-3">
                    ...
                    <button
                      ...
                      disabled={saving}
                      className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-red-500 text-text-primary text-sm font-medium hover:bg-red-600 transition-all disabled:opacity-70"
                    >
                      {saving && <Loader2 className="w-4 h-4 animate-spin" />}
                      确认删除
                    </button>
    ...
    <button
      ...
      className={`w-full text-left rounded-xl border p-3 transition-all ${
        selected
          ...
          : 'bg-black/5 border-white/10 hover:bg-black/[0.08]'
      }`}
    >
