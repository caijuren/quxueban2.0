      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg max-h-[90vh] rounded-3xl flex flex-col overflow-hidden bg-surface border border-primary/30 shadow-glow-lg"
        >
          <div className="relative z-10 p-6 pb-4 border-b border-border-subtle flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              disabled={saving}
              className="w-8 h-8 rounded-lg bg-surface-elevated flex items-center justify-center text-text-secondary hover:text-text-primary hover:bg-surface-highlight transition-all disabled:opacity-50"
              aria-label="关闭"
            >
              <X className="w-4 h-4" />
            </button>
          ...
          >
            {error && (
              <div className="mb-4 flex items-start gap-2 rounded-xl bg-danger/10 border border-danger/20 p-3 text-sm text-danger">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col items-center gap-4">
                <div
                  className="relative w-24 h-24 rounded-full flex items-center justify-center overflow-hidden ring-4 ring-border-subtle"
                  style={{
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-surface-elevated text-text-primary text-xs hover:bg-surface-highlight transition-colors"
                  >
                  ...
                  {avatarUrl && (
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-surface-elevated text-text-secondary text-xs hover:bg-surface-highlight transition-colors"
                    >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="例如：大宝"
                    className={`w-full px-4 py-2.5 rounded-xl bg-surface-elevated border text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:border-primary transition-all ${
                      touched && !name.trim()
                        ? 'border-danger/50'
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 rounded-xl bg-surface-elevated border border-border-default text-sm text-text-primary focus:outline-none focus:border-primary transition-all appearance-none"
                    style={{
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-2.5 rounded-xl bg-surface-elevated border border-border-default text-sm text-text-primary focus:outline-none focus:border-primary transition-all"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    <School className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-text-secondary" />
                    <input
                      type="text"
                      value={currentSchool}
                      onChange={(e) => setCurrentSchool(e.target.value)}
                      placeholder="例如：南翔小学"
                      className="w-full pl-9 pr-4 py-2.5 rounded-xl bg-surface-elevated border border-border-default text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:border-primary transition-all"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <Target className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-text-secondary" />
                    <input
                      type="text"
                      value={targetSchool}
              ...
              <div>
                ...
                {availableRoutes.length > 0 ? (
                  ...
                  <div className="rounded-xl bg-surface-elevated border border-border-default p-4 text-sm text-text-secondary text-center">
                    高中阶段路线即将上线
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full pl-9 pr-4 py-2.5 rounded-xl bg-surface-elevated border border-border-default text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:border-primary transition-all resize-none"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-border-subtle flex items-center justify-between gap-3">
              {isEdit ? (
                <button
                  ...
                  disabled={saving}
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-danger/10 text-danger text-sm hover:bg-danger/20 transition-all disabled:opacity-50"
                >
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  disabled={saving}
                  className="px-4 py-2 rounded-lg bg-surface-elevated text-text-secondary text-sm hover:bg-surface-highlight transition-all disabled:opacity-50"
                >
                  取消
                </button>
                <button
            ...
            {showDeleteConfirm && (
              ...
              >
                <motion.div
                  ...
                  className="w-full max-w-sm rounded-2xl bg-surface border border-border-default p-6 shadow-panel"
                >
    ...
    <button
      ...
      className={`w-full text-left rounded-xl border p-3 transition-all ${
        selected
          ...
          : 'bg-surface-elevated border-border-default hover:bg-surface-highlight'
      }`}
    >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <span
              ...
              style={{ color: route.type === 'primary' ? 'var(--color-primary-glow)' : 'var(--color-secondary)' }}
            >
              {route.name}
            </span>
            <span
