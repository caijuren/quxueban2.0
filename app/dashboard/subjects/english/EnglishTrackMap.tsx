...
import { englishTracks, trackNodes, timeAxisLabels } from '@/lib/subjects/english';
...
export default function EnglishTrackMap() {
  ...
  const getNodesByTrack = (track: 'raz' | 'od' | 'exam') =>
    trackNodes.filter((n) => n.track === track).sort((a, b) => a.position - b.position);
  ...
  const hoveredData = hoveredNode ? trackNodes.find((n) => n.id === hoveredNode) : null;
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
        <div>
          <h2 className="text-xl font-bold font-display">英语三条线规划地图</h2>
      ...
      <div className="relative w-full overflow-x-auto">
        ...
        >
          <defs>
            {(['raz', 'od', 'exam'] as const).map((trackId) => {
