    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-slate-600">各 RAZ 级别对应的蓝思值和证书水平</p>
        </div>
      </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-white/10">
              <th className="text-left py-3 px-3 text-xs font-medium text-slate-600">RAZ 级别</th>
              <th className="text-left py-3 px-3 text-xs font-medium text-slate-600">蓝思值</th>
              <th className="text-left py-3 px-3 text-xs font-medium text-slate-600">对应证书</th>
              <th className="text-left py-3 px-3 text-xs font-medium text-slate-600">阶段说明</th>
            </tr>
          </thead>
          <tbody>
            {lexileReference.map((row, index) => (
              <motion.tr
                ...
                className="border-b border-white/5 last:border-0 hover:bg-black/[0.02] transition-colors"
              >
                ...
                <td className="py-3 px-3 text-sm text-slate-700">{row.lexileRange}</td>
                <td className="py-3 px-3 text-sm text-slate-700">{row.equivalent}</td>
                <td className="py-3 px-3 text-sm text-slate-600">{row.description}</td>
              </motion.tr>
            ))}
          </tbody>
        </table>
