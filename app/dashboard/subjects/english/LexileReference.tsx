    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-text-secondary">各 RAZ 级别对应的蓝思值和证书水平</p>
        </div>
      </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-border-subtle">
              <th className="text-left py-3 px-3 text-xs font-medium text-text-secondary">RAZ 级别</th>
              <th className="text-left py-3 px-3 text-xs font-medium text-text-secondary">蓝思值</th>
              <th className="text-left py-3 px-3 text-xs font-medium text-text-secondary">对应证书</th>
              <th className="text-left py-3 px-3 text-xs font-medium text-text-secondary">阶段说明</th>
            </tr>
          </thead>
          <tbody>
            {lexileReference.map((row, index) => (
              ...
              >
                ...
                <td className="py-3 px-3 text-sm text-text-secondary">{row.description}</td>
              </motion.tr>
            ))}
          </tbody>
        </table>
