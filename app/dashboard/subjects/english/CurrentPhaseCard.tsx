    ...
    >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="rounded-xl bg-white/5 p-4 border border-white/5">
          <p className="text-xs text-slate-500 mb-1">OD 进度</p>
        ...
        <div className="rounded-xl bg-white/5 p-4 border border-white/5">
          <p className="text-xs text-slate-500 mb-1">RAZ 级别</p>
          <p className="text-2xl font-bold text-slate-200">{status.razLevel}</p>
          <p className="text-xs text-slate-500 mt-1">目标：{plan.targets.find((t) => t.label.includes('RAZ'))?.target || '维持'}</p>
        </div>

        <div className="rounded-xl bg-white/5 p-4 border border-white/5">
          <p className="text-xs text-slate-500 mb-1">每日英语</p>
          <p className="text-2xl font-bold text-slate-200">{status.dailyEnglishTime}</p>
          <p className="text-xs text-slate-500 mt-1">含听说读写</p>
        </div>
