...
import { mathExamTimeline } from '@/lib/subjects/math';

export default function MathExamTimeline() {
  return (
    <motion.div
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-text-tertiary">袋鼠 → 澳洲 AMC → AMC8，关键节点与报名提醒</p>
        </div>
      </div>
      ...
      <div className="relative">
        ...
        <div className="space-y-4">
          {mathExamTimeline.map((exam, index) => (
            <motion.div
              key={exam.id}
