    ...
    >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="rounded-xl bg-black/5 p-4 border border-white/5">
          <p className="text-xs text-slate-600 mb-1">当前专题</p>
        ...
        <div className="rounded-xl bg-black/5 p-4 border border-white/5">
          <p className="text-xs text-slate-600 mb-1">每日数学</p>
          <p className="text-2xl font-bold text-slate-800">{status.dailyMathTime}</p>
          <p className="text-xs text-slate-600 mt-1">含校内 + 奥数</p>
        </div>
        ...
        <div className="rounded-xl bg-black/5 p-4 border border-white/5">
          <p className="text-xs text-slate-600 mb-1">下一场考试</p>
          <p className="text-lg font-bold text-slate-800">{status.nextExam}</p>
          <p className="text-xs text-slate-600 mt-1">{status.nextExamDate}</p>
        </div>
      </div>
