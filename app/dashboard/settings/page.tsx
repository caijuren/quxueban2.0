    ...
    <div className="space-y-6">
      ...
      >
        <div>
          ...
          <p className="text-sm text-text-secondary">管理账号、通知和界面偏好</p>
        </div>
        ...
        <div ref={dropdownRef} className="relative">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-lg glass border border-border-default text-sm font-medium text-text-primary hover:bg-surface-light transition-colors focus-ring"
          ...
          {dropdownOpen && (
            <div className="absolute right-0 top-full mt-2 w-48 rounded-xl glass border border-border-default overflow-hidden z-50 shadow-dropdown">
              {CATEGORIES.map((cat) => {
