          ...
          <div className="rounded-xl command-panel corner-accent p-6 sm:p-8">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-[#07C160] text-text-primary text-sm font-semibold hover:shadow-[0_0_20px_rgba(7,193,96,0.15)] transition-all duration-200 focus-ring"
              >
