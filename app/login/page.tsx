            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="relative py-2">
                ...
                <div className="relative flex justify-center">
                  <span className="px-2 bg-background text-[10px] text-text-muted uppercase tracking-wider">or</span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-wechat text-white text-sm font-medium hover:bg-wechat/90 transition-colors"
              >
        ...
        {showWechatModal && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-sm rounded-2xl bg-surface-elevated border border-border-subtle p-6"
              onClick={(e) => e.stopPropagation()}
            >
              <button
                type="button"
                onClick={() => setShowWechatModal(false)}
                className="absolute top-4 right-4 inline-flex items-center justify-center w-9 h-9 rounded-lg bg-surface-hover text-text-tertiary hover:bg-surface hover:text-text-secondary transition-colors"
                aria-label="关闭"
              >
                <X className="w-4 h-4" />
              </button>
              ...
              <div className="text-center mb-5">
                <div className="w-12 h-12 rounded-xl bg-wechat/10 flex items-center justify-center mx-auto mb-3 border border-wechat/20">
                  <QrCode className="w-6 h-6 text-wechat" />
                </div>
                <h3 className="text-lg font-bold font-display mb-1 text-text-primary">微信登录即将上线</h3>
                <p className="text-xs text-text-muted">
                  正式版将支持微信扫码一键登录，当前请先使用账号密码登录。
                </p>
              </div>

              <div className="aspect-square max-w-[180px] mx-auto rounded-lg bg-surface border border-border-subtle flex items-center justify-center mb-5">
                <div className="text-center p-4">
                  <QrCode className="w-10 h-10 text-text-muted mx-auto mb-2" />
                  <span className="text-[10px] text-text-muted">微信扫码入口占位</span>
                </div>
              </div>
              ...
              <button
                type="button"
                onClick={() => setShowWechatModal(false)}
                className="w-full inline-flex items-center justify-center px-4 py-2 rounded-lg bg-surface text-sm text-text-secondary hover:bg-surface-hover transition-colors"
              >
                知道了
              </button>
            </motion.div>
