...
const sections = [
  ...
  },
  {
    title: '2. 我们收集的信息',
    content:
      '为提供服务，我们可能会收集以下信息：账号信息（用户名、密码哈希）、家长及孩子基础信息（昵称、年级、目标学校等）、您创建的升学路线与计划、周计划与打卡记录、操作日志及设备信息。我们不会主动收集与升学规划无关的敏感个人信息。',
  },
  {
    title: '3. 信息的使用',
    content:
      '我们使用收集的信息用于：为您提供升学规划、任务拆解、进度追踪与 AI 诊断服务；向您发送任务提醒、系统通知及重要更新；改进产品体验与服务质量；保障账号安全与服务稳定运行。',
  },
  {
    title: '4. 信息的存储与安全',
    content:
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-3xl px-6 py-24">
        <h1 className="mb-4 font-display text-3xl font-bold">隐私协议</h1>
