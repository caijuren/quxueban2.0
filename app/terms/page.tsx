...
const sections = [
  {
    title: '1. 服务说明',
    content:
      '趣学伴是一款面向上海家长的升学规划与执行管理工具，提供路线规划、任务拆解、进度追踪、周任务管理及 AI 检视等功能。本协议是您与本服务之间关于使用相关产品与服务的法律协议。',
  },
  {
    title: '2. 账号注册与安全',
    content:
  ...
  },
  {
    title: '6. 免责声明',
    content:
      '本服务提供的升学政策解读、路线建议、AI 检视等内容仅供参考，不构成教育、法律或投资等专业建议。最终决策由您自行判断并承担责任。我们不对因使用或无法使用本服务造成的直接、间接损失承担责任，除非法律另有规定。',
  },
  {
    title: '7. 协议终止',
    content:
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-3xl px-6 py-24">
        ...
        <p className="mb-12 text-sm text-text-tertiary">更新日期：2026 年 7 月 27 日</p>
        ...
        <div className="space-y-8">
          {sections.map((section) => (
            <section key={section.title}>
              ...
              <p className="leading-relaxed text-text-tertiary">{section.content}</p>
            </section>
          ))}
        </div>
      </div>
